	...
	if(value != "") {
		...
		$.get('suggest.php', {
			...
			if(data.length > 5) {
				...
				$(".suggestions").html("<div id='tellus'>Seems we have not yet found your item<br/><input type='button' class='btn btn-success' id='0_announce' value='Tell us you lost your item' onclick='_announceUI()'/></div>");
			}
		});
		/*
